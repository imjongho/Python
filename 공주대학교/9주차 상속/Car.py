...
class ElectronicCar(Car):   # 상속 자식
    def __init__(self, manufacturer, model, year):
        super().__init__(manufacturer, model, year)     # 부모클래스 Car __init__상속
        self.battery_size = 3600     # 다른 속성값 초기화
